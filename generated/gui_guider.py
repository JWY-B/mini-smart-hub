...
screen_arc_1.set_range(0, 50)
screen_arc_1.set_bg_angles(135, 45)
screen_arc_1.set_value(37)
screen_arc_1.set_rotation(0)
screen_arc_1.set_style_arc_rounded(0,  lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_rounded(0, lv.STATE.DEFAULT)
screen_arc_1.set_pos(17, 26)
screen_arc_1.set_size(150, 150)
# Set style for screen_arc_1, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
screen_arc_1.set_style_bg_opa(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_border_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_radius(6, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_width(12, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_color(lv.color_hex(0xe6e6e6), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_pad_top(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_pad_bottom(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_pad_left(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_1.set_style_pad_right(20, lv.PART.MAIN|lv.STATE.DEFAULT)

# Set style for screen_arc_1, Part: lv.PART.INDICATOR, State: lv.STATE.DEFAULT.
screen_arc_1.set_style_arc_width(12, lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_opa(255, lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_1.set_style_arc_color(lv.color_hex(0xff93b2), lv.PART.INDICATOR|lv.STATE.DEFAULT)

# Set style for screen_arc_1, Part: lv.PART.KNOB, State: lv.STATE.DEFAULT.
screen_arc_1.set_style_bg_opa(255, lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_1.set_style_bg_color(lv.color_hex(0xff0027), lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_1.set_style_bg_grad_dir(lv.GRAD_DIR.NONE, lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_1.set_style_pad_all(5, lv.PART.KNOB|lv.STATE.DEFAULT)

# Create screen_arc_2
screen_arc_2 = lv.arc(screen)
screen_arc_2.set_mode(lv.arc.MODE.NORMAL)
screen_arc_2.set_range(0, 100)
screen_arc_2.set_bg_angles(135, 45)
screen_arc_2.set_value(70)
screen_arc_2.set_rotation(0)
screen_arc_2.set_style_arc_rounded(0,  lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_rounded(0, lv.STATE.DEFAULT)
screen_arc_2.set_pos(175, 26)
screen_arc_2.set_size(150, 150)
# Set style for screen_arc_2, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
screen_arc_2.set_style_bg_opa(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_border_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_width(12, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_color(lv.color_hex(0xe6e6e6), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_radius(6, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_pad_top(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_pad_bottom(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_pad_left(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_pad_right(20, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_arc_2.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)

# Set style for screen_arc_2, Part: lv.PART.INDICATOR, State: lv.STATE.DEFAULT.
screen_arc_2.set_style_arc_width(12, lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_opa(255, lv.PART.INDICATOR|lv.STATE.DEFAULT)
screen_arc_2.set_style_arc_color(lv.color_hex(0x2195f6), lv.PART.INDICATOR|lv.STATE.DEFAULT)

# Set style for screen_arc_2, Part: lv.PART.KNOB, State: lv.STATE.DEFAULT.
screen_arc_2.set_style_bg_opa(255, lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_2.set_style_bg_color(lv.color_hex(0x0032ff), lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_2.set_style_bg_grad_dir(lv.GRAD_DIR.NONE, lv.PART.KNOB|lv.STATE.DEFAULT)
screen_arc_2.set_style_pad_all(5, lv.PART.KNOB|lv.STATE.DEFAULT)

# Create screen_label_1
screen_label_1 = lv.label(screen)
screen_label_1.set_text("temp")
screen_label_1.set_long_mode(lv.label.LONG.WRAP)
screen_label_1.set_width(lv.pct(100))
screen_label_1.set_pos(43, 157)
...
screen_label_1.set_style_text_color(lv.color_hex(0xf56060), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_label_2.set_style_text_color(lv.color_hex(0x2f52ff), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_ddlist_1.set_options("AUTO\n25%\n50%\n75%\n100%")
screen_ddlist_1.set_pos(342, 83)
